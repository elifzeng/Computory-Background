记录一些numpy技巧
## randomly select elements of an array with NumPy
```python
import numpy as np
...
print(np.random.choice(prog_langs, size=10,replace=True, p=[0.3, 0.5, 0.0, 0.2]))
# output
```
![image](https://user-images.githubusercontent.com/52747634/224243120-6cd808e7-b5dd-485f-9221-d70bf8ad180b.png)
